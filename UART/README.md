...
# Coverage Report
    ...
    =============================================
    | Covergroup Coverage |      1 |    68.284% |
    |---------------------|--------|------------|
    | Types               |        |      0 / 1 |
    =============================================
    WEIGHTED AVERAGE LOCAL: 68.284%
    ...
    |                                              |          | At Least |           |
    ==================================================================================
    | TYPE /\package tb_pkg\/uart_coverage/dut_cov |  68.284% | 100.000% | Uncovered |
    ==================================================================================
    | INSTANCE <UNNAMED1>                          |  68.284% | 100.000% | Uncovered |
    |----------------------------------------------|----------|----------|-----------|
    | COVERPOINT <UNNAMED1>::BAUD                  | 100.000% | 100.000% | Covered   |
    |----------------------------------------------|----------|----------|-----------|
    | bin baud_val[4800]                           |        1 |        1 | Covered   |
    | bin baud_val[9600]                           |        1 |        1 | Covered   |
    | bin baud_val[14400]                          |        3 |        1 | Covered   |
    | bin baud_val[19200]                          |        2 |        1 | Covered   |
    | bin baud_val[38400]                          |        2 |        1 | Covered   |
    | bin baud_val[57600]                          |        1 |        1 | Covered   |
    |----------------------------------------------|----------|----------|-----------|
    | COVERPOINT <UNNAMED1>::LENGTH                | 100.000% | 100.000% | Covered   |
    |----------------------------------------------|----------|----------|-----------|
    | bin length_val[5]                            |        3 |        1 | Covered   |
    | bin length_val[6]                            |        3 |        1 | Covered   |
    | bin length_val[7]                            |        1 |        1 | Covered   |
    | bin length_val[8]                            |        3 |        1 | Covered   |
    |----------------------------------------------|----------|----------|-----------|
    | COVERPOINT <UNNAMED1>::PARITY                | 100.000% | 100.000% | Covered   |
    |----------------------------------------------|----------|----------|-----------|
    | bin odd_parity[0]                            |        5 |        1 | Covered   |
    | bin even_parity[1]                           |        5 |        1 | Covered   |
    |----------------------------------------------|----------|----------|-----------|
    | COVERPOINT <UNNAMED1>::TX_DATA               |   3.921% | 100.000% | Uncovered |
    |----------------------------------------------|----------|----------|-----------|
    | bin auto[0]                                  |        0 |        1 | Zero      |
    | bin auto[1]                                  |        0 |        1 | Zero      |
    | bin auto[2]                                  |        0 |        1 | Zero      |
    ...
    | bin auto[99]                                 |        0 |        1 | Zero      |
    | bin auto[100]                                |        0 |        1 | Zero      |
    | bin auto[101]                                |        0 |        1 | Zero      |
    ...
    | bin auto[254:255]                            |        0 |        1 | Zero      |
    |----------------------------------------------|----------|----------|-----------|
    | CROSS <UNNAMED1>::BAUD_X_LENGTH              |  37.500% | 100.000% | Uncovered |
    |----------------------------------------------|----------|----------|-----------|
    | bin <baud_val[4800],length_val[7]>           |        1 |        1 | Covered   |
    | bin <baud_val[9600],length_val[5]>           |        1 |        1 | Covered   |
    | bin <baud_val[14400],length_val[6]>          |        2 |        1 | Covered   |
    | bin <baud_val[14400],length_val[8]>          |        1 |        1 | Covered   |
    | bin <baud_val[19200],length_val[5]>          |        1 |        1 | Covered   |
    | bin <baud_val[19200],length_val[8]>          |        1 |        1 | Covered   |
    | bin <baud_val[38400],length_val[5]>          |        1 |        1 | Covered   |
    | bin <baud_val[38400],length_val[8]>          |        1 |        1 | Covered   |
    | bin <baud_val[57600],length_val[6]>          |        1 |        1 | Covered   |
    ==================================================================================
